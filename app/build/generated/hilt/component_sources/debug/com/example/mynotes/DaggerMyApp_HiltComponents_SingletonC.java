...
import com.example.mynotes.di.AppModule_ProvideNoteDatabaseFactory;
import com.example.mynotes.di.AppModule_ProvideNoteRepositoryFactory;
...
public final class DaggerMyApp_HiltComponents_SingletonC {
  ...
  private static final class ActivityCImpl extends MyApp_HiltComponents.ActivityC {
    ...
    public Map<Class<?>, Boolean> getViewModelKeys() {
      return LazyClassKeyMap.<Boolean>of(Collections.<String, Boolean>singletonMap(LazyClassKeyProvider.com_example_mynotes_NoteViewModel, NoteViewModel_HiltModules.KeyModule.provide()));
    }
    ...
    private static final class LazyClassKeyProvider {
      static String com_example_mynotes_NoteViewModel = "com.example.mynotes.NoteViewModel";

      @KeepFieldType
      NoteViewModel com_example_mynotes_NoteViewModel2;
    }
  }
  ...
  private static final class ViewModelCImpl extends MyApp_HiltComponents.ViewModelC {
    ...
    private void initialize(final SavedStateHandle savedStateHandleParam,
      ...
      this.noteViewModelProvider = new SwitchingProvider<>(singletonCImpl, activityRetainedCImpl, viewModelCImpl, 0);
    }

    @Override
    public Map<Class<?>, javax.inject.Provider<ViewModel>> getHiltViewModelMap() {
      return LazyClassKeyMap.<javax.inject.Provider<ViewModel>>of(Collections.<String, javax.inject.Provider<ViewModel>>singletonMap(LazyClassKeyProvider.com_example_mynotes_NoteViewModel, ((Provider) noteViewModelProvider)));
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.example.mynotes.NoteViewModel 
          return (T) new NoteViewModel(singletonCImpl.provideNoteRepositoryProvider.get(), ApplicationContextModule_ProvideContextFactory.provideContext(singletonCImpl.applicationContextModule));
  ...
  private static final class SingletonCImpl extends MyApp_HiltComponents.SingletonC {
    ...
    private Provider<NotesDatabase> provideNoteDatabaseProvider;

    private Provider<NoteRepositoryImpl> provideNoteRepositoryProvider;
    ...
    private void initialize(final ApplicationContextModule applicationContextModuleParam) {
      this.provideNoteDatabaseProvider = DoubleCheck.provider(new SwitchingProvider<NotesDatabase>(singletonCImpl, 1));
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.example.mynotes.data.repository.NoteRepositoryImpl 
          return (T) AppModule_ProvideNoteRepositoryFactory.provideNoteRepository(singletonCImpl.provideNoteDatabaseProvider.get());

          case 1: // com.example.mynotes.data.database.NotesDatabase 
